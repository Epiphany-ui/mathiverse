...
- Name: sandbox-studio.spec.ts >> keeps the exact responsive viewport, essential controls, and reduced motion
- Location: e2e/sandbox-studio.spec.ts:137:5
...
Call log:
  - waiting for locator('[data-studio-motion-layer="shell"]')
